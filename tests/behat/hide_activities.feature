...
Feature: Testing hide_activities in local_solent
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | page     | TestPage     | C1     | page1     | 1       |
      | assign   | TestAssign   | C1     | assign1   | 1       |
      | lesson   | TestLesson   | C1     | lesson1   | 1       |
      | feedback | TestFeedback | C1     | feedback1 | 1       |
  ...
  Scenario: No activities are hidden in the activity chooser
    ...
    And I should see "TestPage" in the "Topic 1" "section"
    And I should see "TestAssign" in the "Topic 1" "section"
    And I should see "TestLesson" in the "Topic 1" "section"
    And I should see "TestFeedback" in the "Topic 1" "section"
